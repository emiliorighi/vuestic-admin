<template>
  ...
  <va-data-table :items="assemblies" :columns="['accession', 'scientific_name', 'assembly_name', 'actions']">
    <template #cell(actions)="{ rowData }">
      <va-chip :to="{ name: 'annotation-form', params: { assemblyAccession: rowData.accession } }" icon="edit"
